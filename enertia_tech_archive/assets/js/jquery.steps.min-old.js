...
$(document).ready(function() {
	...
	$('.first-next-btn').click(function() {
		if($('#station_Name').val() != '' && $('#searchAddress').val() != '' ){
			...
			$('#station_Name').addClass('red-placeholder');
		}
		$('#station_Name').keypress(function() {
		...
		if($('#station_Name').val() != '' && $('#searchAddress').val() != '' ){
			...
			$('#searchAddress').addClass('red-placeholder');
		}
		$('#searchAddress').keypress(function() {
			$('#searchAddress').css('border-color', 'lightgray');
		});
	});
	...
	$('.second-next-btn').click(function() {
		if($('#provider_name').val() != '' && $('#from_day_time').val() != '' && $('#from_day_time').val() != '' && $('#to_day_time').val() != '' && $('#from_time').val() != '' && $('#to_time').val() != '' ){
			...
			$('#provider_name').addClass('red-placeholder');
		}
		...
		if($('#provider_name').val() != '' && $('#from_day_time').val() != ''  && $('#to_day_time').val() != '' && $('#from_time').val() != '' && $('#to_time').val() != '' ){
			...
			$('#from_day_time').addClass('red-placeholder');
		}
		$('#from_day_time').change(function() {
		...
		if($('#provider_name').val() != '' && $('#from_day_time').val() != '' && $('#to_day_time').val() != '' && $('#from_time').val() != '' && $('#to_time').val() != '' ){
			...
			$('#from_time').addClass('red-placeholder');
		}
		...
		$('#to_time').change(function() {
			$('#to_time').css('border-color', 'lightgray');
		});
	});
	$('.second-back-btn').click(function() {
		$('.second-slide').hide();
		$('.first-slide').show();
	});

	// Third slide
	$('.third-back-btn').click(function() {
		$('.third-slide').hide();
		$('.second-slide').show();
	});
	...
	// Third slide
	$('.fourth-back-btn').click(function() {
		$('.fourth-slide').hide();
		$('.third-slide').show();
	});
	$('.fourth-next-btn').click(function() {
		$('.fourth-slide').hide();
	});
});