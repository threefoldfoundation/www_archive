...
// Todo-task
    ...
    $(function() {
        ...
        $('.add-new-todo-btn').on("click", function(event) {
          ...
          if (item) {
            todoListItem.append("<div class='todo-box'><i class='remove fa fa-trash-o'></i><div class='todo-task'><label class='ckbox'><input type='checkbox'/><span>" + item + "</span><i class='input-helper'></i></label></div></div>");
            todoListInput.val("");
          }
