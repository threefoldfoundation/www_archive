...
class Package(j.baseclasses.threebot_package):
    ...
    def _init(self, **kwargs):
        ...
        self.freeflowevent = "https://github.com/freeflownation/www_freeflowevent.git"
    ...
    def prepare(self):
        ...
        server.configure()
        website = server.websites.get("freeflowevent")
        website.ssl = False
        website.port = 80
        locations = website.locations.get("freeflowevent")
        static_location = locations.locations_static.new()
        static_location.name = "static"
        static_location.path_url = "/"
        path = j.clients.git.getContentPathFromURLorPath(self.freeflowevent, branch=self.branch, pull=True)
